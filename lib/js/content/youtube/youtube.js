; (function () {
  ...
  function addDailyTopLink() {
    ...
    if (isActive) {
      btn.style.setProperty("background-color", "var(--yt-spec-10-percent-layer)"); 
    } else {
      btn.style.setProperty("background-color", "rgba(0, 0, 0, 0)"); 
    }
    ...
    text.style.setProperty("color", "var(--yt-spec-text-primary)");
    ...
    path.setAttribute("fill", "var(--yt-spec-brand-icon-inactive)");
